        ...
        <div className="min-h-screen bg-gray-950 flex items-center justify-center">
            <div className="bg-gray-900 p-8 rounded-2xl shadow-lg w-full max-w-md">
                ...
                <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                    ...
                    <button
                        onClick={() => { }}
                        className="flex items-center justify-center  gap-3 w-full py-2.5 px-4 bg-white text-[#3c4043] text-sm font-medium border border-[#dadce0] rounded-lg hover:bg-gray-50 hover:shadow-sm transition-all duration-200 cursor-pointer">
